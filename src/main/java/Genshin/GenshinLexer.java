...
public class GenshinLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "T__18", "T__19", "T__20", "T__21", "STRING", "INT", "FLOAT", 
			"ID", "WS", "LETTER", "DIGIT", "CHINESE", "SL_COMMENT", "ML_COMMENT", 
			"DOC_COMMENT"
		};
	}
	...
	public GenshinLexer(CharStream input) {
		super(input);
